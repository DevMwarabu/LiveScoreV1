...
public class StandingHomeAdapter extends RecyclerView.Adapter<StandingHomeAdapter.ViewHolder> {
    private Context context;
    private String season,leagueId;
    private List<Standing> standings;

    public StandingHomeAdapter(Context context, List<Standing> standings, String season,String leagueId) {

...
public class StandingAdapter extends RecyclerView.Adapter<StandingAdapter.ViewHolder> {
    ...
    public StandingAdapter(Context context, List<Standing> standings,String season,String leagueId) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(String _rank,String _team,String _mp,String win,String draw,String _fg,String _ga,String url){
            ...
            if (!win.equals("null") && !draw.equals("null")){
                gd.setText(String.valueOf(gaol_diff));
                pts.setText(String.valueOf(points));
            }else {
                gd.setText(String.valueOf("0"));
                pts.setText(String.valueOf("0"));

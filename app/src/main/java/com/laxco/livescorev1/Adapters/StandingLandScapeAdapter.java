...
public class StandingLandScapeAdapter extends RecyclerView.Adapter<StandingLandScapeAdapter.ViewHolder> {
    private Context context;
    private String season,leagueId;
    private List<Standing> standings;

    public StandingLandScapeAdapter(Context context, List<Standing> standings, String season,String leagueId) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        try {
            holder.setData(
                    ...
                    standing.getAll().getString("played"),
                    standing.getAll().getString("win"),
                    standing.getAll().getString("draw"),
                    standing.getAll().getString("lose"),
                    standing.getAll().getJSONObject("goals").getString("for"),
                    standing.getAll().getJSONObject("goals").getString("against"),

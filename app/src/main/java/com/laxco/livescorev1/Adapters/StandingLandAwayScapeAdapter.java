...
public class StandingLandAwayScapeAdapter extends RecyclerView.Adapter<StandingLandAwayScapeAdapter.ViewHolder> {
    private Context context;
    private String season,leagueId;
    private List<Standing> standings;

    public StandingLandAwayScapeAdapter(Context context, List<Standing> standings, String season,String leagueId) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        try {
            holder.setData(
                    ...
                    standing.getAway().getString("lose"),

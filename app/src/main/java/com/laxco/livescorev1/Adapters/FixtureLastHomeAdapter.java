...
public class FixtureLastHomeAdapter extends RecyclerView.Adapter<FixtureLastHomeAdapter.ViewHolder> {
    private Context context;
    private List<FixtureHome> fixtures;

    public FixtureLastHomeAdapter(Context context, List<FixtureHome> fixtures) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        FixtureHome fixture = fixtures.get(position);
        try {
            holder.setData(
    ...
    public void addAll(List<FixtureHome> fixtures) {

...
public class FragToday extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        url = Constants.baseUrl+"fixtures?date=" + getDate() + "&status=NS-PEN-1H-2H-ET-P-BT-FT";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_frag_today, container, false);
                ...
                if (mInterstitialAd != null) {
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            startActivity(new Intent(getContext(), MoreLives.class).putExtra("isLive",false).putExtra("title","Today Games").putExtra("date",getDate()));
                        }

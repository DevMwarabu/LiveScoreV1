...
public class StandingLandHomeScapeAdapter extends RecyclerView.Adapter<StandingLandHomeScapeAdapter.ViewHolder> {
    private Context context;
    private String season,leagueId;
    private List<Standing> standings;

    public StandingLandHomeScapeAdapter(Context context, List<Standing> standings, String season,String leagueId) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.standings_items_landscape, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        try {
            holder.setData(
                    ...
                    standing.getHome().getString("played"),
                    standing.getHome().getString("win"),
                    standing.getHome().getString("draw"),
                    standing.getHome().getString("lose"),
                    standing.getHome().getJSONObject("goals").getString("for"),
                    standing.getHome().getJSONObject("goals").getString("against"),
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            w = itemView.findViewById(R.id.tv_w);
            d = itemView.findViewById(R.id.tv_d);
            l = itemView.findViewById(R.id.tv_l);
            gf = itemView.findViewById(R.id.tv_f);
            ga = itemView.findViewById(R.id.tv_a);

            logo = itemView.findViewById(R.id.image_team_logo);
            mCardView = itemView.findViewById(R.id.card_main);
        }

        private void setData(String _rank,String _team,String _mp,String win,String draw,String loSS,String _fg,String _ga,String url){

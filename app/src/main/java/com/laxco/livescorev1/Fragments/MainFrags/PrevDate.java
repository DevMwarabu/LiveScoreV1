...
public class PrevDate extends Fragment {
    private View view;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            url = Constants.baseUrl + "fixtures?date=" + getDatePrev(getDate()) + "&status=NS-PEN-1H-2H-ET-P-BT-FT";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_prev_date, container, false);
                ...
                if (mInterstitialAd != null) {
                    ...
                    mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            try {
                                startActivity(new Intent(getContext(), MoreLives.class).putExtra("isLive",false).putExtra("title","Yesterday's Games").putExtra("date",getDatePrev(getDate())));
                            } catch (ParseException e) {
                                e.printStackTrace();
                            }
                        }
